                ...
                <header id="image-1" class="d-flex h-100">
                    <div class=" row justify-content-center align-self-center col-md-12" style="z-index: 3;">
                        ...
                        <p style="text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;" class="col-md-8">
                            ...
                            mengatasi permasalahan pendidikan, sosial, dan ekonomi yang hadir di tengah-tengah
                            masyarakat
                            ...
                            robusta, premium robusta, dan lanang. Tiap biji kopi yang kami hadirkan telah melewati
                            proses
                            sortasi yang ketat demi menjaga citarasa dan kualitas.
                            Dapatkan produk pesantren kopi melalui marketplace dan Instagram @pesantrenkopi. Dapatkan
                            cerita dari tiap
